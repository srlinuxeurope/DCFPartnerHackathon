...
| [Customize the CLI](./hackathon/activities/srlinux-i-custom-cli) | SR Linux | Advanced |
| [Using gNMI with Python](./hackathon/activities/srlinux-i-pygnmi) | SR Linux | Advanced |

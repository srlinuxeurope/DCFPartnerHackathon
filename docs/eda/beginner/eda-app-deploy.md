...
[workflows]: https://docs.eda.dev/26.8/development/apps/components/#workflows
...
[EDA App Catalogs](https://docs.eda.dev/26.8/development/custom-catalog/) are structured Git repositories that contain all the information EDA needs in order to discover and install an app contained in the catalog.
...
- Download the [`edabuilder` CLI tool](https://docs.eda.dev/26.8/development/apps/setup-env/) that assist in every step of the application lifecycle, including publishing the application components to a registry and creating a catalog entry.

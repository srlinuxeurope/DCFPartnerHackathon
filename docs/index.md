...
To access the lab nodes from within the VM, users should identify the names of the deployed nodes using the `sudo containerlab inspect -a` command.  You will notice they all start with `clab-dcfpartnerws-`.  Your entire network is [powered by ContainerLab](https://containerlab.dev).
...
12:41:27 INFO Removed container name=clab-dcfpartnerws-prometheus
12:41:27 INFO Removed container name=clab-dcfpartnerws-promtail
12:41:27 INFO Removed container name=clab-dcfpartnerws-leaf12
12:41:27 INFO Removed container name=clab-dcfpartnerws-spine12
12:41:28 INFO Removed container name=clab-dcfpartnerws-gnmic
12:41:28 INFO Removed container name=clab-dcfpartnerws-grafana
12:41:28 INFO Removed container name=clab-dcfpartnerws-leaf13
12:41:28 INFO Removed container name=clab-dcfpartnerws-dns
12:41:28 INFO Removed container name=clab-dcfpartnerws-client11
12:41:28 INFO Removed container name=clab-dcfpartnerws-client21
12:41:29 INFO Removed container name=clab-dcfpartnerws-client13
12:41:29 INFO Removed container name=clab-dcfpartnerws-client02
12:41:29 INFO Removed container name=clab-dcfpartnerws-client01
12:41:29 INFO Removed container name=clab-dcfpartnerws-pe2
12:41:29 INFO Removed container name=clab-dcfpartnerws-pe1
12:41:30 INFO Removing host entries path=/etc/hosts
12:41:30 INFO Removing SSH config path=/etc/ssh/ssh_config.d/clab-dcfpartnerws.conf
```
...
- [SR Linux Release 25.7](https://documentation.nokia.com/srlinux/25-7/index.html)
...
- [SR OS Release 25.7](https://documentation.nokia.com/sr/25-7/index.html)
...
As you can imagine, creating the activities that make up this hackathon is a lot of work. The hackathon team would like to thanks the following team members (in alphabetical order) for their contributions: Alexandre Silvestre, Asad Arafat, Diogo Pinheiro, Gordon Gidofalvy, Guilherme Cale, Hans Thienpondt, James Cumming, Joao Machado, Kaelem Chandra, Laleh Kiani, Louis Van Eeckhoudt, Maged Makramalla, Miguel Redondo Ferrero, Patrick Haechler, Roman Dodin, Saju Salahudeen, Samier Barguil, Shafkat Waheed, Shashi Sharma, Simon Tibbitts, Siva Sivakumar, Subba Konda, Sven Wisotzky, Thomas Hendriks, Tiago Amado, Tim Raphael, Vasileios Tekidis, Víctor Serrano and Zeno Dhaene.

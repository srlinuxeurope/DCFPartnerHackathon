...
This section contains the activities for the SR Linux Network Operating System (NOS) stream of the 2025 SReXperts hackathon.
...
In this hackathon you have the opportunity to undertake challenges on the SR Linux NOS with a focus on model-driven automation and programmability.
...
- When you complete an activity (or even if you don't manage to complete it), you will find a very short questionnaire at the end.  Would you please fill it out as honestly as you feel able to, we won't be offended if you think something was awful, and equally we like praise as much as the next person!

These two small asks will help us continue to improve your experience for when you return next year!

## Gaining access to the network
<!-- TBU - Update this section-->
Each group has their own complete network, including an IP core running segment routing, multiple data-centers, a broadband network and client and subscriber devices.  This is your playground.  It is all pre-configured and operating as a real end-to-end network would.  

The SR Linux stream activities focus on the SR Linux devices in the network, but many of them also use the Linux client and subscriber devices as well.
...
Not only are the team here to help you with anything in the hackathon, but they also have a wide range of knowledge about Nokia, our products, our services and our technologies.  
Please ask anything that's on your mind.
